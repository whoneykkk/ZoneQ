  ...
  return (
    <div style={{ overflowX: "auto" }}>
      ...
      >
        ...
        />
        {vals.map((v, i) => (
          <circle key={i} cx={px(i)} cy={py(v)} r="3" fill={ZQ.blue} />
        ))}
        <rect
          x={lastX - 9}
          y={lastY - 20}
      ...
      >
        ...
        <div style={{ display: "flex", gap: 16 }}>
          {[
            ...
            },
            {
              ...
              color: ZQ.text,
              bordered: true,
              action: () => navigate("/messages/compose"),
            },
          ].map((item) => (
            <button
              key={item.label}
              ...
              style={{
                ...
                gap: 8,
                background: item.bg,
                border: item.bordered ? `1px solid ${ZQ.border}` : "none",
        ...
        {causes && (
          ...
          >
            ...
            {causes.map((c) => (
              <NoiseBar key={c.label} label={c.label} pct={c.pct} />
            ))}
          </div>
        )}
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <div>
                    ...
                    >
                      {v.avgDb}{" "}
                      <span style={{ fontSize: 10, fontWeight: 400 }}>dB</span>
                    </div>
                  </div>
